...
public class ItemServiceImplTest {
    ...
    void createItemWithRequestTest() {
        ...
        RequestDto itemRequest = requestService.saveRequest(createDto, regularUser.getId());
        ...
        itemRequest = requestService.getRequestById(itemRequest.getId());
        assertEquals(itemRequest.getItems().get(0).getId(), createdItem.getId());
    }
